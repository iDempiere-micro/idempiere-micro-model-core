...
public final class DB {
  ...
  private static ICConnection s_cc = null;
  /** Logger */
   ...
   * @param cc connection
   */
  public static synchronized void setDBTarget(ICConnection cc) {
  ...
  public static boolean isOracle() {
    if (s_cc != null) return s_cc.getOracle();
    log.severe("No Database Connection");
    return false;
  } //	isOracle
  ...
  public static boolean isPostgreSQL() {
    if (s_cc != null) return s_cc.getPostgreSQL();
