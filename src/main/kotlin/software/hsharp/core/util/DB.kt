...
fun prepareStatement(
    sql: String?,
    trxName: String?
): PreparedStatement? = throw Exception(NYI)
...
// CONVERTERS
internal fun TO_DATE(time: Timestamp, dayOnly: Boolean): String = throw Exception(NYI)

internal fun TO_STRING(txt: String?, maxLength: Int): String = throw Exception(NYI)
fun TO_STRING(txt: String?): String = throw Exception(NYI)
